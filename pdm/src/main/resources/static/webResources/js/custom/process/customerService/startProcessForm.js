...
$(document).ready(function() {
	...
	$("#customerServiceForm").validate({
		...
		submitHandler: function(form) {
            $("#startDetail\\.project\\.number").attr("disabled","disabled")
			var options = {
				type : "post",
	...
	$("#startDetail\\.estimatedTime").datetimepicker({language: 'zh-CN', format: 'yyyy-mm-dd hh:ii:ss',todayBtn:'true',todayHighlight:'true', startDate:new Date()});
