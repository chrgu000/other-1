...
$(document).ready(function() {
	$("#instrumentForm").validate({
		...
		submitHandler: function(form) {
			var options = {
				type : "post",
				url : '/instrument/save?deviceId='+$('#deviceId').val(),
	...
	$("#lastCheckOutDate").datetimepicker({language: 'zh-CN', format: 'yyyy-mm-dd hh:ii:ss',todayBtn:'true',todayHighlight:'true'})

    $("#nextCheckOutDate").datetimepicker({language: 'zh-CN', format: 'yyyy-mm-dd hh:ii:ss',todayBtn:'true',todayHighlight:'true'})
