...
$(document).ready(function() {
		...
		$.extend(jQuery.jgrid.defaults, {
		 ...
		 var colModel=[
           	{label:$.i18n.prop('roleFunctionGroup.name'),name:'name',index:'name', width: '90', sortable:true, align: 'center'},
			{label:$.i18n.prop('roleFunctionGroup.roleFunction'),name:'roleFunction',index:'roleFunction', width: '150', sortable:false, align: 'center',
