...
public class AccountController extends BaseController<Account> {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/account/toSaveAccountPage", method = RequestMethod.GET)
	public ModelAndView toSaveAccountPage(@RequestParam(value = "id", required = false) Long id)  {
	...
	public JSONObject save(@ModelAttribute("account") Account account,
		...
		Oplog.Operation operation = account.getId() == null ? Oplog.Operation.ADD : Oplog.Operation.EDIT;
		accountService.save(account, password, roles, roleFunctionGroups, selRolesFunctionNode);
		saveLog("人员", operation, account.getLoginId());
